...
const emptyApplication: ApplicationDraft = {
  ...
  requirements: "",
  requirementEvidence: [],
  offerDetails: { baseSalary: "", currency: "ILS", bonus: "", equity: "", benefits: "", titleLevel: "", startDate: "", responseDeadline: "", workModel: "", additionalTerms: "", verifiedAt: "" },
  capturedAt: "",
  salary: "",
  budgetRange: "",
  salaryCurrency: "ILS",
...
function normalizeApplication(value: Partial<Application>): Application {
  return {
    ...
    offerDetails: {
      ...
      ...(value.offerDetails || {}),
      currency: ["ILS", "USD", "EUR", "GBP", "Other"].includes(value.offerDetails?.currency || "") ? value.offerDetails!.currency : "ILS",
    },
