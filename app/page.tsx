...
export default function Home() {
  ...
  const [expandedTools, setExpandedTools] = useState({ studio: false, social: false, cv: false, interview: false, search: true, analytics: true });
  ...
  function navigateToSection(target: string) {
    const tool = target === "message-studio" ? "studio" : target === "social-studio" ? "social" : target === "cv-lab" ? "cv" : target === "interview-prep" ? "interview" : target === "job-search" ? "search" : target === "analytics" ? "analytics" : null;
  ...
  function openInterviewSupport(application: Application) {
    ...
    setExpandedTools((current) => ({ ...current, interview: true, cv: false, studio: false, social: false }));
  ...
  function openCvSupport(application: Application) {
    ...
    setExpandedTools((current) => ({ ...current, cv: true, interview: false, studio: false, social: false }));
      ...
      <div className="calm-content mx-auto flex max-w-7xl flex-col gap-8">
        ...
        <section className={`calm-view message-studio-panel ${activeView !== "tools" ? "calm-view-hidden" : ""}`} id="message-studio">
          <div className="section-heading tool-card-heading relative">
            ...
            <div className="tool-card-actions"><button aria-expanded={expandedTools.studio} className="secondary-button" onClick={() => setExpandedTools((current) => ({ ...current, studio: !current.studio, social: false, cv: false, interview: false }))} type="button">{language === "he" ? (expandedTools.studio ? "סגירת הסטודיו" : "פתיחת הסטודיו") : (expandedTools.studio ? "Close studio" : "Open studio")}<ChevronDown className={`h-4 w-4 transition ${expandedTools.studio ? "rotate-180" : ""}`} /></button></div>
          </div>
        ...
        <section className={`calm-view social-studio-panel ${activeView !== "tools" ? "calm-view-hidden" : ""}`} id="social-studio">
          <div className="section-heading tool-card-heading relative">
            ...
            <div className="tool-card-actions"><button aria-expanded={expandedTools.social} className="secondary-button" onClick={() => setExpandedTools((current) => ({ ...current, social: !current.social, studio: false, cv: false, interview: false }))} type="button">{expandedTools.social ? (language === "he" ? "סגירת הסטודיו" : "Close studio") : (language === "he" ? "פתיחת הסטודיו" : "Open studio")}<ChevronDown className={`h-4 w-4 transition ${expandedTools.social ? "rotate-180" : ""}`} /></button></div>
          </div>
